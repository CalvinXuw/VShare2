...
import com.ifeng.vshare.adapter.VideoTopicRelativeAdapter;
...
import com.ifeng.vshare.requestor.VideoTopicRequestor.VideoTopicTopItem;
 ...
 * 
 */
public class VideoTopicFragment extends VShareFragment implements
	 ...
	 * @return
	 */
	public static VideoTopicFragment getInstance(int id) {
		VideoTopicFragment topicFragment = new VideoTopicFragment();
	...
	/** adapter */
	private VideoTopicRelativeAdapter mRelativeVideosAdapter;
	/** 执行刷新的view */
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mHeader.mHeadView = (ViewGroup) inflater.inflate(
				R.layout.video_topic_description, null);
		mHeader.mTitle = (TextView) mHeader.mHeadView
				.findViewById(R.id.text_video_topic_title);
		mHeader.mDesc = (TextView) mHeader.mHeadView
				.findViewById(R.id.text_video_topic_desc);
		mHeader.mImg = (ImageView) mHeader.mHeadView
				.findViewById(R.id.image_video_topic);
	...
	public void onCacheLoaded(AbstractRequestor requestor) {
		...
		if (mRelativeVideosAdapter != null) {
			return;
		}
	...
	private synchronized void addHeader(BaseVSharePageRequestor requestor) {
		final VideoTopicTopItem topItem = mTopicRequestor.getTopone();
		if (topItem != null
	...
	private synchronized void updateDatas(BaseVSharePageRequestor requestor) {
		if (mRelativeVideosAdapter == null) {
			...
			mRelativeVideosAdapter = new VideoTopicRelativeAdapter(
					getActivity(), mImageFetcher, mTopicRequestor);
			mListView.setAdapter(mRelativeVideosAdapter);
		}
		...
		mRelativeVideosAdapter.notifyDataSetChanged();
	...
	protected void setupModel() {
		mTopicRequestor = new VideoTopicRequestor(getActivity(), getArguments()
