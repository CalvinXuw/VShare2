 ...
 * 
 */
public class DiscountEmptyRequestState extends EmptyRequestState {

	public DiscountEmptyRequestState(Activity context,
	...
	protected View createView() {
		View stateView = LayoutInflater.from(mActivity).inflate(
				R.layout.state_empty_discount, null);
		View headView = stateView.findViewById(R.id.image_state_empty_discount);
		headView.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,
				(int) (Utility.getScreenWidth(mActivity) / 720 * 340)));
